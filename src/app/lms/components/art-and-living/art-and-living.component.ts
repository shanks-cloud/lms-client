...
@Component({
  selector: 'app-art-and-living',
  templateUrl: './art-and-living.component.html',
  styleUrls: ['./art-and-living.component.css']
})

export class ArtAndLivingComponent implements OnInit {
